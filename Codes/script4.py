...
msg_initial = 'f5 fe '
msg_red = '00 '  # light strength is from 00 to ff
msg_green = 'ff '
msg_blue = '00 '
msg_end = '00 ef'
# for LOOP control
...
if len(sys.argv) > 1:
    print("\n\tUpgrated System pressed, with input for solar:", sys.argv[2])
    print("\n\tUpgrated System pressed, with input for batteries:", sys.argv[1])
